...
public class Proyecto1 {
    ...
    public static void main(String[] args) {
        ...
        sim.createProcess("Proceso_IO_1", 0, 45, ProcessType.IO_BOUND, 5, 15, 4);
        
        // I/O Bound: 25 instrucciones, I/O cada 2 ciclos, servicio de 7 ciclos
        sim.createProcess("Proceso_IO_2", 0, 30, ProcessType.IO_BOUND, 2, 7, 9);
        
        // CPU Bound: 55 instrucciones, sin I/O
        sim.createProcess("Proceso_CPU_2", 0, 55, ProcessType.CPU_BOUND, 0, 0, 10);
        
        // I/O Bound: 40 instrucciones, I/O cada 10 ciclos, servicio de 15 ciclos
        sim.createProcess("Proceso_IO_3", 0, 40, ProcessType.IO_BOUND, 10, 15, 4);
        
        // I/O Bound: 20 instrucciones, I/O cada 2 ciclos, servicio de 8 ciclos
        sim.createProcess("Proceso_IO_4", 0, 20, ProcessType.IO_BOUND, 2, 8, 5);
        
        // CPU Bound: 65 instrucciones, sin I/O
        sim.createProcess("Proceso_CPU_3", 0, 65, ProcessType.CPU_BOUND, 0, 0, 4);
        ...
        sim.createProcess("Proceso_CPU_5", 0, 30, ProcessType.CPU_BOUND, 0, 0, 12);
        
        // I/O Bound: 40 instrucciones, I/O cada 5 ciclos, servicio de 7 ciclos
        sim.createProcess("Proceso_IO_5", 0, 40, ProcessType.IO_BOUND, 5, 7, 2);
